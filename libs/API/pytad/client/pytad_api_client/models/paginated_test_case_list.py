...
T = TypeVar("T", bound="PaginatedTestCaseList")


@_attrs_define
class PaginatedTestCaseList:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = TestCase.from_dict(results_item_data)
        ...
        paginated_test_case_list.additional_properties = d
        return paginated_test_case_list
