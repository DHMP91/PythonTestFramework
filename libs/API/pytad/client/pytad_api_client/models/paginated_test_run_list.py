...
T = TypeVar("T", bound="PaginatedTestRunList")


@_attrs_define
class PaginatedTestRunList:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = TestRun.from_dict(results_item_data)
        ...
        paginated_test_run_list.additional_properties = d
        return paginated_test_run_list
